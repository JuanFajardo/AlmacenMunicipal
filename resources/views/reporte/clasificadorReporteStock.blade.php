  ...
  <body>
    ...
    <table width="100%">
      <tr style="text-align: center;">
        <td>
          <h3> REPORTE DE SUMINISTROS Y MATERIALES  </BR>PARTIDAS</h3>
    ...
    @foreach($clasificadores as $clasificador)
      <table width="100%" border="0">
        <tr style="text-align: left;">
          <td>
            <b> Partida: {{ $clasificador->codigo }} - {{ $clasificador->clasificador }} </b>
          </td>
        </tr>
      </table>
      <?php $sumaTotal=0; ?>
      <table width="100%" border="1" style="padding:0px; margin:0px;">
          <thead  style="background-color:#BECCD2;">
            ...
            <tr>
              ...
              <td width="5%" style="text-align:left;">Nro Movimiento</td>
            ...
            @if($dato->movimiento == 'INGRESO STOCK' || $dato->movimiento == 'SALIDA STOCK' )
              <?php
                $bienAuxiliar = \DB::table('articulos_movimientos')->join('movimientos',         'articulos_movimientos.id_movimiento',  '=', 'movimientos.id')
                                                                    ...
                                                                    ->where('articulos_movimientos.id_clasificador',  '=', $dato->id_clasificador)
