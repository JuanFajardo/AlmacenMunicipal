    ...
    <div id="cuerpo">
        <table width="100%" style=" padding: 1px;  border-collapse: collapse;">
          ...
          <tr>
            ...
            @if( !empty($movimientoDato->rupe))
              <td class="uno" colspan="2"><label> <b>RUPE:</b> </label>{{$movimientoDato->rupe}}</td>
            @endif
            @if( !empty($movimientoDato->codigo_tramite))
          ...
          <tr>
            <td colspan="2" style="padding: 8px;
              text-align: left;"> <label> {{$movimientoDato->tipo_factura}}  No.</label> :  {{$movimientoDato->numero_factura}} </td>
             <td colspan="2" style="padding: 8px;
              text-align: left;"><b> Monto:</b>
              {{ number_format($movimientoDato->total_factura , 2, ",", ".") }}
             </td>
           </tr>
           @endif
        </table>
        ...
        <table width="100%" border="1" >
          <thead   style="border:solid 1px black; background-color:#BECCD2;">
            <tr>
              <td style="text-align:center;" colspan="9"><b>Artículos</td>
            </tr>
            <tr>
              <!-- Nº. Apertura, Clasificador, codigo articulo, detalle, unidad, Cantidad,
              total,
              Nro_de boleta, funcionario, Automovil,
              -->
    ...
    <div id="piedepagina">
      <table width="100%" border="1">
        <tr>
          ...
          <td width="50%">
            <table width="100%">
              <tr><td colspan="2"><label><b>Firmas</label> <br></br><br></br><br><br></td></tr>
              <tr>
                <td width="50%" style="text-align: center;">Resp. Almacen<br></td>
                <td width="50%" style="text-align: center;">Recibido<br>{{$dato->nombres}} {{$dato->paterno}} {{$dato->materno}}</td>
                <br>
              </tr>
            </table>
           </td>
