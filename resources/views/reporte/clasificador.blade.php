...
<div class="warper container-fluid">
  <div class="row">
    <div class="col-lg-12">
      <h3><i class="fa fa-th"></i> Clasificadores Presupuestarios</h3>

      {!! Form::open(['url'=>'/Reportes/clasificador', 'autocomplete'=>'off', 'method'=>'post']) !!}
      <div class="row">
        <div class="col-md-2">
          <label> Gestion  </label>
        ...
        <div class="col-md-8">
          <label>Pártida de Gasto</label>
          <input type="text" name="id_clasificador"  list="clasificadores" placeholder="Eliga un clasificador" class="form-control" >
          <datalist id="clasificadores">
            @foreach($clasificadores as $clasificador)
              <option value="{{$clasificador->codigo}} - {{$clasificador->clasificador}}">
            @endforeach
          </datalist>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-4" style="padding-top:10px;">
          <button type="submit" name="button" value="pdfInmediato" class="btn btn-info"> <i class="fa fa-file-pdf-o"></i> Reporte por Inmediato  </button>
        </div>
        <div class="col-md-4" style="padding-top:10px;">
          <button type="submit" name="button" value="pdfStock" class="btn btn-primary"> <i class="fa fa-file-pdf-o"></i> Reporte por Stock </button>
        </div>
