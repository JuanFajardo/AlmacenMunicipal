...
<div class="warper container-fluid">
  <div class="row">
    <div class="col-lg-12">
      <h3><i class="fa fa-truck"></i> Proveedor </h3>

      {!! Form::open(['url'=>'/Reportes/proveedor', 'autocomplete'=>'off', 'method'=>'post']) !!}
      <div class="row">
        <div class="col-md-2">
          <label> Gestion  </label>
        ...
        <div class="col-md-8">
	         ...
	         <datalist id="proveedores">
	           @foreach($proveedores as $proveedor)
	             <option value="{{$proveedor->id}}- {{$proveedor->proveedor}} - {{$proveedor->nit}}">
	           @endforeach
	         </datalist>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-2" style="padding-top:15px;">
          <button type="submit" name="button" class="btn btn-info"> <i class="fa fa-file-pdf-o"></i> Reporte por Proveedores</button>
        </div>
      </div>
      {!! Form::close() !!}
