...
<div class="panel panel-default">
    <div class="panel-heading clean">
      <h3><i class="fa fa-external-link-square"></i>  <b>{{$moviento}} DE COMBUSTIBLE  N° {{ $nro_moviento }}</b></h3>
    </div>
    <div class="panel-body">

        {!! Form::open(['url'=>'Movimiento/salidaCombustibleS', 'mehtod'=>'post', 'id'=>'formEnvio', 'autocomplete'=>'off', 'id'=>'formEnvio']) !!}
        ...
        <div class="row">
          <div class="form-group col-md-12">
            <h4><span class="glyphicon glyphicon-asterisk col-md-12" style="color: #0288D1; padding: 20px; background-color: #B3E5FC;"><b> FECHAS Y TIPOS DE SALIDA DE COMBUSTIBLE  </b></span> </h4>
            <div class="col-md-3">
        ...
        <div class="row">
          ...
          <table class="table table-striped" border="1">
            ...
            //////////////////////////////////////////////////////////////
            -->
            <datalist id="id_funcionariol">
            </datalist>
            <?php $autos = \DB::table('autos')->get(); ?>
            <datalist id="id_autol">
                    ...
                    <table width="100%">
                      ...
                      <tr>
                        <td>
                          ...
                          <input type="text" id="id_funcionarios{{$i}}" name="id_funcionario{{$i}}" class="form-control" placeholder="Escriba el funcionario" list="id_funcionariol" required >
                        </td>
                        <td>
                          <label >Placa</label>
                          <input type="text" id="id_auto{{$i}}" name="id_auto{{$i}}" class="form-control" placeholder="Escriba placa del auto" list="id_autol" required >
                        </td>
                        <td>
                          <label >Nro Boleta</label>
                          <input type="text" id="boleta{{$i}}" name="boleta{{$i}}" class="form-control" placeholder="Nro Boleta" required >
                        </td>
                        <td>
                          <label >Observacion</label>
                          <input type="text" id="observacion{{$i}}" name="observacion{{$i}}" class="form-control" placeholder="observacion" required >
                        </td>
                      </tr>
                    </table>
                  </td>
