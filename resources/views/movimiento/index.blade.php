...
<div class="panel panel-default">
    <div class="panel-heading clean">
      <h3><i class="fa fa-th-list"></i>  <b>Movimientos</b></h3>
    </div>
            ...
            <tbody>
              ...
              @endif
                ...
                @if($dato->movimiento == 'SALIDA STOCK')
                  <?php $totalSalidaStock = \DB::table('articulos_movimientos')->where('id_movimiento', '=', $dato->id)->sum('total_actual') ?>
                  <td> {{ number_format($totalSalidaStock, 2, ",", ".") }} </td>
                @else
